...
public class TSBChatMessageNextMessage extends BaseTSBRequestMessage<TSBChatMessageSendData> {

    public static final String NAME = "engine_chat:message:next";

    public TSBChatMessageNextMessage() {
        super(NAME);
    }
